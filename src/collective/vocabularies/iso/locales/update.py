...
domain = 'collective.vocabularies.iso'
os.chdir(pkg_resources.resource_filename(domain, ''))
os.chdir('../../../')
target_path = 'src/collective/iso/'
...
def _rebuild():
    cmd = '{i18ndude} rebuild-pot --pot {locale_path}/{domain}.pot --exclude {exclude} --create {domain} {target_path}'.format(  # NOQA: E501
        i18ndude=i18ndude,
